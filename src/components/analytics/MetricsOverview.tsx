    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <div className="bg-white dark:bg-[#111722] border border-gray-200 dark:border-white/[0.08] rounded-2xl p-4.5 flex flex-col justify-between shadow-xs transition-colors">
        <div className="flex items-center justify-between pb-3 border-b border-gray-100 dark:border-white/[0.06]">
          ...
          <span className="text-[10.5px] font-mono font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 px-2 py-0.5 rounded-full border border-emerald-200 dark:border-emerald-800/60">
            {metrics.winRate}% Win
          </span>
        </div>
        ...
        <div className="my-3">
          <div className="flex items-baseline justify-between">
            <span className="text-2xl lg:text-3xl font-mono font-extrabold text-gray-900 dark:text-white">
              {metrics.winningTrades}W <span className="text-gray-400 dark:text-neutral-600 text-lg font-normal">/</span> {metrics.losingTrades}L
            </span>
          ...
          {/* Win/Loss Dual Bar */}
          <div className="w-full bg-gray-100 dark:bg-[#161D2A] h-2 rounded-full mt-2.5 overflow-hidden flex">
            <div 
      ...
      <div className="bg-white dark:bg-[#111722] border border-gray-200 dark:border-white/[0.08] rounded-2xl p-4.5 flex flex-col justify-between shadow-xs transition-colors">
        <div className="flex items-center justify-between pb-3 border-b border-gray-100 dark:border-white/[0.06]">
          ...
          <span className="text-[10.5px] font-mono font-bold text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/40 px-2 py-0.5 rounded-full border border-blue-200 dark:border-blue-800/60">
      ...
      <div className="bg-white dark:bg-[#111722] border border-gray-200 dark:border-white/[0.08] rounded-2xl p-4.5 flex flex-col justify-between shadow-xs transition-colors">
        <div className="flex items-center justify-between pb-3 border-b border-gray-100 dark:border-white/[0.06]">
          ...
          <span className={`text-[10.5px] font-mono font-bold px-2 py-0.5 rounded-full ${
            isNetPositive ? 'text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800/60' : 'text-rose-700 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-900/50'
          }`}>
      ...
      <div className="bg-white dark:bg-[#111722] border border-gray-200 dark:border-white/[0.08] rounded-2xl p-4.5 flex flex-col justify-between shadow-xs transition-colors">
        <div className="flex items-center justify-between pb-3 border-b border-gray-100 dark:border-white/[0.06]">
          ...
          <span className="text-[10.5px] font-mono text-gray-600 dark:text-neutral-300 bg-gray-100 dark:bg-[#161D2A] px-2 py-0.5 rounded-full border border-gray-200 dark:border-white/[0.08]">
